...
def test_add_one_tile_to_an_empty_row():
    ...
    assert building_rows.building_rows[0].filled_slots == 1
    assert building_rows.building_rows[0].color == "red"
...
def test_add_many_tiles_to_empty_row():
    ...
    assert building_rows.building_rows[2].color == "blue"

def test_add_one_tile_to_non_empty_row():
    building_rows = BuildingRows()
    building_rows.add_tiles_to_building_row(2, "teal", 1)
    building_rows.add_tiles_to_building_row(2, "teal", 1)
